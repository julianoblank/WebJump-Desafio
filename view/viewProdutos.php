...
<main class="content">
    <div class="header-list-page">
        ...
        <a href="/public/adicionarProduto" class="btn-action">Add new Product</a>
    </div>
        ...
        <?php if(count($produtos)> 0){
            foreach ($produtos as $key => $produto): ?>
                <tr class="data-row">
                    ...
                    <td class="data-grid-td">
                        <span class="data-grid-cell-content">R$ <?=str_replace('.',',',number_format($produto->getPreco(),2))?></span>
                    </td>
                    ...
                    <td class="data-grid-td">
                        <span class="data-grid-cell-content"><?=$nomeCategoria[$key]?></span>
                    </td>

                    <td class="data-grid-td">
                        <div class="actions">
                            <a class="btn-edit" href="/public/editarProduto?id=<?=$produto->getId()?>">Edit</a>
                            <a class="btn-delete" onclick="return confirm('Deseja mesmo excluir esse produto ?');" href="/public/excluirProduto?id=<?=$produto->getId()?>">Delete</a>
                        </div>
                    </td>
                </tr>
            <?php endforeach; }?>
