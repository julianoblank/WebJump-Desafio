...
<main class="content">
    <div class="header-list-page">
        ...
        <a href="/public/adicionarCategoria" class="btn-action">Add new Category</a>
    </div>
            ...
            foreach ($categorias as $categoria): ?>
                <tr class="data-row">
                    <td class="data-grid-td">
                        <span class="data-grid-cell-content"><?= $categoria->getNome() ?></span>
                    </td>
                    ...
                    <td class="data-grid-td">
                        <div class="actions">
                            <a class="btn-edit" href="/public/editarCategoria?id=<?=$categoria->getId()?>">Edit</a>
                            <a class="btn-delete" onclick="return confirm('Deseja mesmo excluir esta categoria ?');" href="/public/excluirCategoria?id=<?=$categoria->getId()?>">Delete</a>
                        </div>
                    </td>
                </tr>
        <?php endforeach;
