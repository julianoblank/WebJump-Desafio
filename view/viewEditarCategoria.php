...
<main class="content">
    ...
    ?>
    <form method="POST" action="/public/salvarCategoria<?= isset($categoria) ? '?id='.$categoria->getId() : '';?>">
        <div class="input-field">
            <label for="category-name" class="label">Category Name</label>
            <input type="text" id="category-name" name="name" class="input-text" value="<?= isset($categoria) ? $categoria->getNome() : ''; ?>"/>
        </div>
        <div class="input-field">
            <label for="category-code" class="label">Category Code</label>
            <input type="text" id="category-code" class="input-text" name="codigo" value="<?= isset($categoria) ? $categoria->getCodigo() : ''; ?>"/>

        </div>
        <div class="actions-form">
            <a href="/public/categorias" class="action back">Back</a>
